...
@register_implementation("circleshub_operateFlowMatrix")
class CirclesHubOperateFlowMatrix(BaseImplementation):
    """Implementation for operateFlowMatrix in CirclesHub"""

    def get_calls(self, context: SimulationContext) -> List[ContractCall]:
        """Generate operateFlowMatrix call(s).
