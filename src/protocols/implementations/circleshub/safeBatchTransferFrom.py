...
@register_implementation("circleshub_safeBatchTransferFrom")
class CirclesHubSafeBatchTransferFrom(BaseImplementation):
    """Implementation for safeBatchTransferFrom in CirclesHub"""
    ...
    def get_calls(self, context: SimulationContext) -> List[ContractCall]:
        ...
        constraints = context.agent.profile.get_action_config(
            "circleshub_safeBatchTransferFrom"
        ).constraints
