...
@register_implementation("circlesdemurrageerc20_onERC1155Received")
class CirclesDemurrageERC20OnERC1155Received(BaseImplementation):
    """Implementation for onERC1155Received in CirclesDemurrageERC20"""
    ...
    def get_calls(self, context: SimulationContext) -> List[ContractCall]:
        ...
        constraints = context.agent.profile.get_action_config(
            "circlesdemurrageerc20_onERC1155Received"
        ).constraints
