...
@register_implementation("circlesdemurrageerc20_transferFrom")
class CirclesDemurrageERC20TransferFrom(BaseImplementation):
    """Implementation for transferFrom in CirclesDemurrageERC20"""
    ...
    def get_calls(self, context: SimulationContext) -> List[ContractCall]:
        ...
        constraints = context.agent.profile.get_action_config(
            "circlesdemurrageerc20_transferFrom"
        ).constraints
