...
@register_implementation("balancerv2vault_batchSwap")
class BalancerV2VaultBatchSwap(BaseImplementation):
    """Implementation for batchSwap in BalancerV2Vault"""

    def get_calls(self, context: SimulationContext) -> List[ContractCall]:
        """Generate batchSwap call(s).
