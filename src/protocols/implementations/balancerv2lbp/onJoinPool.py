...
@register_implementation("balancerv2lbp_onJoinPool")
class BalancerV2LBPOnJoinPool(BaseImplementation):
    """Implementation for onJoinPool in BalancerV2LBP"""

    def get_calls(self, context: SimulationContext) -> List[ContractCall]:
        """Generate onJoinPool call(s).
