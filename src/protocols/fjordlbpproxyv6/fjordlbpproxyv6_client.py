...
class FjordLbpProxyV6Client:
    ...
    def LBPFactoryAddress(self, ) -> str:
    ...
    def WeightedPoolFactoryAddress(self, ) -> str:
    ...
    def allowedFundTokens(self, ) -> List[str]:
    ...
    def createWeightedPoolForLBP(self, sender: str, lbpPool: str, weightedPoolConfig: Any) -> bool:
    ...
    def exitPool(self, sender: str, pool: str, maxBPTTokenOut: int, isStandardFee: bool) -> bool:
    ...
    def getFeeRecipients(self, ) -> List[str]:
    ...
    def getWeightedPools(self, ) -> List[str]:
    ...
    def platformAccessFeeBPS(self, ) -> int:
    ...
    def renounceOwnership(self, sender: str, ) -> bool:
    ...
    def updateRecipients(self, sender: str, recipients: List[str], recipientShareBPS: List[int]) -> bool:
    ...
    def weightedPoolCount(self, ) -> int:
