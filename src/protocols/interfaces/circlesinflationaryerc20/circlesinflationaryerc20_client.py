...
class CirclesInflationaryERC20Client:
    """Generic client interface for CirclesInflationaryERC20 contract"""
    ...
    def __init__(
        ...
        try:
            ...
            logger.debug(
                f"Successfully loaded CirclesInflationaryERC20 ABI from {abi_path}"
            )
