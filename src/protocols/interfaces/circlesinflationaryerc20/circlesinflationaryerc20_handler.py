...
from src.protocols.interfaces.circlesinflationaryerc20.circlesinflationaryerc20_client import (
    CirclesInflationaryERC20Client,
)
...
class ApproveBaseHandler:
    ...
    def __init__(
        self,
        client: CirclesInflationaryERC20Client,
        chain,
        logger,
