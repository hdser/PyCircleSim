...
class CirclesBackingFactoryClient:
    ...
    def INSTANCE_BYTECODE_HASH(self, ) -> bytes:
    ...
    def backingParameters(self, ) -> Tuple[str, str, str, int]:
    ...
    def createLBP(self, sender: str, value: int, personalCRC: str, personalCRCAmount: int, backingAsset: str, backingAssetAmount: int, context: Optional['SimulationContext'] = None) -> bool:
    ...
    def exitLBP(self, sender: str, value: int, lbp: str, bptAmount: int, context: Optional['SimulationContext'] = None) -> bool:
    ...
    def getPersonalCircles(self, sender: str, value: int, avatar: str, context: Optional['SimulationContext'] = None) -> bool:
    ...
    def notifyRelease(self, sender: str, value: int, lbp: str, context: Optional['SimulationContext'] = None) -> bool:
        ...
        """
        try:
            tx = self.contract.notifyRelease(
                lbp, 
                sender=sender,
                value=value
            )
    ...
    def onERC1155Received(self, sender: str, value: int, operator: str, from_: str, id: int, value_amount: int, data: bytes, context: Optional['SimulationContext'] = None) -> bool:
        ...
        try:
            tx = self.contract.onERC1155Received(
                operator, from_, id, value_amount, data, 
                sender=sender,
                value=value
            )
            success = bool(tx and tx.status == 1)
    ...
    def setReleaseTimestamp(self, sender: str, value: int, timestamp: Any, context: Optional['SimulationContext'] = None) -> bool:
    ...
    def setSupportedBackingAssetStatus(self, sender: str, value: int, backingAsset: str, status: bool, context: Optional['SimulationContext'] = None) -> bool:
