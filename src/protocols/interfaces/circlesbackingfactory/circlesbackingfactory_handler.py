...
from src.protocols.interfaces.circlesbackingfactory.circlesbackingfactory_client import (
    ...
    def execute(
        ...
        try:
            ...
            function_args = {
                ...
                "value_": execution_params.get(
                    "amount_value"
                ),  # Contract's value parameter
...
class SetSupportedBackingAssetStatusBaseHandler:
    ...
    def execute(
        ...
        try:
            ...
            self.logger.error(
                f"setSupportedBackingAssetStatus action failed: {e}", exc_info=True
            )
            return False
